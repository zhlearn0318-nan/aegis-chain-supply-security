...
def test_active_summaries_do_not_keep_the_previous_backend_count() -> None:
    for relative in ("README.md", "demo_web/README.md"):
        ...
        assert "557 passed" in content
        for previous in (
            "507 passed", "501 passed", "495 passed", "450 passed", "447 passed", "422 passed", "396 passed", "395 passed", "390 passed",
