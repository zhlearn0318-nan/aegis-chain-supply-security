...
| F2 | {'ALLOW': 26, 'BLOCK': 4, 'REVIEW': 9, 'UNKNOWN': 1} | 79.2% | 4.2% | 4.2% | 4 | 30 |
| F3 | {'ALLOW': 27, 'BLOCK': 3, 'REVIEW': 9, 'UNKNOWN': 1} | 83.3% | 0.0% | 4.2% | 3 | 31 |

## 当前结论

- 低权限自动放行率：83.3%；
- 低权限直接阻断：0；
- 无必要 REVIEW/BLOCK 相对 F0 减少：57.1%；
- 被抑制发现仍以 INFO 留存：31 条；
- 完整高风险规则被降级：0 条；
- 真实 Skill 兼容性接受门：通过；
